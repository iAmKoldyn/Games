...
%CC% -DSDL_MAIN_HANDLED -I%WININC% -I%WININC%\..\shared -I%GLEW%\include -I%SDL%\include -I%SDLIMG%\include -L%GLEW%\bin\Release\%ARCHW% -L%SDL%\lib\%ARCH% -L%SDLIMG%\lib\%ARCH% -lmsvcrt -lglew32 -lOpenGL32 -lSDL2 -run mine.c
